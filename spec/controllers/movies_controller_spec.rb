...
describe MoviesController do
  ...
  let(:valid_attributes) { { "imdb_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved movie as @movie" do
        ...
        post :create, {:movie => { "imdb_id" => "invalid value" }}, valid_session
        assigns(:movie).should be_a_new(Movie)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested movie" do
        ...
        Movie.any_instance.should_receive(:update).with({ "imdb_id" => "MyString" })
        put :update, {:id => movie.to_param, :movie => { "imdb_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the movie as @movie" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Movie.any_instance.stub(:save).and_return(false)
        put :update, {:id => movie.to_param, :movie => { "imdb_id" => "invalid value" }}, valid_session
        assigns(:movie).should eq(movie)
      end
